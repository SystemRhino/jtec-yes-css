...
if($_FILES['img_1']['size'] > 0 || $_FILES['img_2']['size'] > 0){
    if ($_POST['nm_noticia'] == "" || $_POST['ds_noticia'] == "" || $_POST['id_categoria'] == ""){
        $strong = "Preencha todos os campos e selecione uma categoria";
